      ...
      elements: [
        {
          ...
          name: "Set question",
          title:
            "Let S be a well defined set (a set with no ambiguity on whether an object belongs to the set), for example C = {a,b,c} is well-defined as it is clear what is and is not in the set. Let {} be the empty set with no elements, which of the following statements are always true. (PICK ONE)",
          isRequired: true,
          choices: [
            {
              value: "set-1",
        ...
        },
        {
          ...
          name: "question12",
          title:
            "If the teacher marks all the exam papers, they will get paid 50 pounds, the teacher did not get paid 50 pounds, which of the following conclusions are valid? (select one)",
          isRequired: true,
          choices: [
            {
              value: "implication-1",
        ...
        },
        {
          ...
          maxWidth: "600",
          title:
            "Tick all check boxes which can be deduced assuming the two statements above are true",
          isRequired: true,
          choices: [
            {
              value: "correct",
        ...
        },
        {
          ...
          title:
            "Check all boxes which results in the statement above holding in the given circumstance",
        ...
        },
        {
          ...
          title:
            "Consider the above statement The negation of this statement is",
          isRequired: true,
          choices: [
            {
              value: "a",
